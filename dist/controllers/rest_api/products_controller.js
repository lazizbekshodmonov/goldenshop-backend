...
const getProducts = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const response = yield product_model_1.ProductModel.find();
        const products = [];
...
const deleteProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const deletedProject = yield product_model_1.ProductModel.findByIdAndDelete(req.params.id);
        res.status(200).json({ id: deletedProject === null || deletedProject === void 0 ? void 0 : deletedProject.id });
    }
    catch (error) {
        res.status(404).json({
...
const updateProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const updatedProduct = product_model_1.ProductModel.findByIdAndUpdate(req.params.id);
